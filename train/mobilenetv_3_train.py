...
class train():
    def __init__(self, model, num_class):
        ...
        self.model.classifier[3] = nn.Linear(num_features, num_class)
    ...
    def train_model(self, criterion, optimizer, scheduler, num_epochs=25):
     ...
     # Create a temporary directory to save training checkpoints
        best_model_params_path = 'mobilenetv3_best.pt'
    ...
    def plot_confusion_matrix(self):
        ...
        plt.savefig("mobilenet_v3_confusion_matrix.png")
if __name__ == "__main__":
    mobilenet_v3 = models.mobilenet_v3_large(pretrained=True)
    num_class = 45
    criterion = nn.CrossEntropyLoss()
    optimizer_ft = optim.SGD(mobilenet_v3.parameters(), lr=0.001, momentum=0.9)
    exp_lr_scheduler = lr_scheduler.StepLR(optimizer_ft, step_size=7, gamma=0.1)
    train = train(mobilenet_v3, num_class)
